...
weather_str={
    ...
    feel_temp_str:f'Feels like temperature of {temp_feel}k\n',
    humid_str:f'Humidity: {humid}\n',
    wind_str:f'Wind: Wind speed of {wind_speed} with gusts up to {wind_gust}\n',
    weather_str:f'Weather: {w_description}\n',
    visibility_str:f'visibility of {visible}\n'
}
